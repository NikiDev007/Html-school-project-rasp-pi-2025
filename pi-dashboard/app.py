...
def get_network_details():
    ...
    try:
        ...
        gateway_cmd_output = get_system_info(['ip', 'route', 'show', 'default'])
        gateway = gateway_cmd_output.split(' ')[2] if gateway_cmd_output and 'default via' in gateway_cmd_output else "N/A"
...
def status_api():
    ...
    try:
        ...
        cpu_temp = round(int(temp_raw) / 1000, 1) if temp_raw and temp_raw.isdigit() else "N/A"
